...
int build_ProvisioningServicesCapabilities_xml(char * p_buf, int mlen)
{
    ...
    {
        offset += build_SourceCapabilities_xml(p_buf+offset, mlen-offset, &g_onvif_cfg.Capabilities.provisioning.Source[i]);
    }
...
int build_tds_GetServices_rly_xml(char * p_buf, int mlen, const char * argv)
{
	...
	offset += build_Version_xml(p_buf+offset, mlen-offset, 19, 12);
	...
	if (g_onvif_cfg.Capabilities.events.support)
	{
		...
		offset += build_Version_xml(p_buf+offset, mlen-offset, 19, 6);
		offset += snprintf(p_buf+offset, mlen-offset, "</tds:Service>");
	}
	...
	if (g_onvif_cfg.Capabilities.ptz.support)
	{
		...
		offset += build_Version_xml(p_buf+offset, mlen-offset, 17, 6);
		offset += snprintf(p_buf+offset, mlen-offset, "</tds:Service>");
	}
#endif	
	...
	if (g_onvif_cfg.Capabilities.recording.support)
	{
		...
		offset += build_Version_xml(p_buf+offset, mlen-offset, 18, 6);
		offset += snprintf(p_buf+offset, mlen-offset, "</tds:Service>");
	}
	...
	if (g_onvif_cfg.Capabilities.search.support)
	{
		...
		offset += build_Version_xml(p_buf+offset, mlen-offset, 2, 4);
		offset += snprintf(p_buf+offset, mlen-offset, "</tds:Service>");
	}
    ...
    if (g_onvif_cfg.Capabilities.accessrules.support)
    {
        ...
        offset += build_Version_xml(p_buf+offset, mlen-offset, 18, 12);
        offset += snprintf(p_buf+offset, mlen-offset, "</tds:Service>");
    }
#endif // end of ACCESS_RULES
    ...
    if (g_onvif_cfg.Capabilities.receiver.support)
    {
        ...
        offset += build_Version_xml(p_buf+offset, mlen-offset, 2, 1);
        offset += snprintf(p_buf+offset, mlen-offset, "</tds:Service>");
    }
#endif // end of RECEIVER_SUPPORT
...
int build_tds_GetDynamicDNS_rly_xml(char * p_buf, int mlen, const char * argv)
{
	...
	offset += snprintf(p_buf+offset, mlen-offset, "<tds:GetDynamicDNSResponse><tds:DynamicDNSInformation>");

    offset += snprintf(p_buf+offset, mlen-offset, 
        "<tt:Type>%s</tt:Type>", 
        onvif_DynamicDNSTypeToString(g_onvif_cfg.network.DynamicDNSInformation.Type));

    if (g_onvif_cfg.network.DynamicDNSInformation.NameFlag)
    {
        offset += snprintf(p_buf+offset, mlen-offset, 
            "<tt:Name>%s</tt:Name>", 
            g_onvif_cfg.network.DynamicDNSInformation.Name);
    }

    if (g_onvif_cfg.network.DynamicDNSInformation.TTLFlag)
    {
        offset += snprintf(p_buf+offset, mlen-offset, 
            "<tt:TTL>%d</tt:TTL>", 
            g_onvif_cfg.network.DynamicDNSInformation.TTL);
    }
    
	offset += snprintf(p_buf+offset, mlen-offset, "</tds:DynamicDNSInformation></tds:GetDynamicDNSResponse>");
...
int build_Message_xml(char * p_buf, int mlen, onvif_Message * p_req)
{
	int offset = 0;
	char utctime[64];
...
int build_NotificationMessage_xml(char * p_buf, int mlen, onvif_NotificationMessage * p_req)
{
	...
	offset += build_Message_xml(p_buf+offset, mlen-offset, &p_req->Message);
	offset += snprintf(p_buf+offset, mlen-offset, "</wsnt:Message>");
...
int build_ImagePreset_xml(char * p_buf, int mlen, onvif_ImagingPreset * p_req)
{
    int offset = 0;
...
{
	int offset = 0;
	AudioEncoder2ConfigurationList * p_a_enc_cfg = onvif_find_AudioEncoder2Configuration(g_onvif_cfg.a_enc_cfg, token);
    if (NULL == p_a_enc_cfg)
    {
    	return ONVIF_ERR_NoConfig;
    }
...
int build_trt_GetAudioDecoderConfigurationOptions_rly_xml(char * p_buf, int mlen, const char * argv)
{
	...
	if (p_a_dec_cfg->Options.AACDecOptionsFlag)
	{
	    offset += snprintf(p_buf+offset, mlen-offset, "<tt:AACDecOptions>");
	    offset += snprintf(p_buf+offset, mlen-offset, "<tt:Bitrate>");
	    offset += build_IntList_xml(p_buf+offset, mlen-offset, &p_a_dec_cfg->Options.AACDecOptions.Bitrate);
	    offset += snprintf(p_buf+offset, mlen-offset, "</tt:Bitrate>");
	    offset += snprintf(p_buf+offset, mlen-offset, "<tt:SampleRateRange>");
	    offset += build_IntList_xml(p_buf+offset, mlen-offset, &p_a_dec_cfg->Options.AACDecOptions.SampleRateRange);
	    offset += snprintf(p_buf+offset, mlen-offset, "</tt:SampleRateRange>");
	    offset += snprintf(p_buf+offset, mlen-offset, "</tt:AACDecOptions>");
	}
	if (p_a_dec_cfg->Options.G711DecOptionsFlag)
	{
	    offset += snprintf(p_buf+offset, mlen-offset, "<tt:G711DecOptions>");
	    offset += snprintf(p_buf+offset, mlen-offset, "<tt:Bitrate>");
	    offset += build_IntList_xml(p_buf+offset, mlen-offset, &p_a_dec_cfg->Options.G711DecOptions.Bitrate);
	    offset += snprintf(p_buf+offset, mlen-offset, "</tt:Bitrate>");
	    offset += snprintf(p_buf+offset, mlen-offset, "<tt:SampleRateRange>");
	    offset += build_IntList_xml(p_buf+offset, mlen-offset, &p_a_dec_cfg->Options.G711DecOptions.SampleRateRange);
	    offset += snprintf(p_buf+offset, mlen-offset, "</tt:SampleRateRange>");
	    offset += snprintf(p_buf+offset, mlen-offset, "</tt:G711DecOptions>");
	}
	if (p_a_dec_cfg->Options.G726DecOptionsFlag)
	{
	    offset += snprintf(p_buf+offset, mlen-offset, "<tt:G726DecOptions>");
	    offset += snprintf(p_buf+offset, mlen-offset, "<tt:Bitrate>");
	    offset += build_IntList_xml(p_buf+offset, mlen-offset, &p_a_dec_cfg->Options.G726DecOptions.Bitrate);
	    offset += snprintf(p_buf+offset, mlen-offset, "</tt:Bitrate>");
	    offset += snprintf(p_buf+offset, mlen-offset, "<tt:SampleRateRange>");
	    offset += build_IntList_xml(p_buf+offset, mlen-offset, &p_a_dec_cfg->Options.G726DecOptions.SampleRateRange);
	    offset += snprintf(p_buf+offset, mlen-offset, "</tt:SampleRateRange>");
	    offset += snprintf(p_buf+offset, mlen-offset, "</tt:G726DecOptions>");
	}	
...
int build_PTZSpaces_xml(char * p_buf, int mlen, onvif_PTZSpaces * p_req)
{
    ...
    if (p_req->AbsolutePanTiltPositionSpaceFlag)
	{
		offset += snprintf(p_buf+offset, mlen-offset, 
			"<tt:AbsolutePanTiltPositionSpace>"
				...
				"</tt:YRange>"
			"</tt:AbsolutePanTiltPositionSpace>", 
			p_req->AbsolutePanTiltPositionSpace.XRange.Min,
			p_req->AbsolutePanTiltPositionSpace.XRange.Max,
			p_req->AbsolutePanTiltPositionSpace.YRange.Min,
			p_req->AbsolutePanTiltPositionSpace.YRange.Max);
	}

	if (p_req->AbsoluteZoomPositionSpaceFlag)
	{
		offset += snprintf(p_buf+offset, mlen-offset, 
			"<tt:AbsoluteZoomPositionSpace>"
				...
				"</tt:XRange>"
			"</tt:AbsoluteZoomPositionSpace>", 
			p_req->AbsoluteZoomPositionSpace.XRange.Min,
			p_req->AbsoluteZoomPositionSpace.XRange.Max);
    }

    if (p_req->RelativePanTiltTranslationSpaceFlag)
    {
		offset += snprintf(p_buf+offset, mlen-offset, 
			"<tt:RelativePanTiltTranslationSpace>"
				...
				"</tt:YRange>"
			"</tt:RelativePanTiltTranslationSpace>",
			p_req->RelativePanTiltTranslationSpace.XRange.Min,
			p_req->RelativePanTiltTranslationSpace.XRange.Max,
			p_req->RelativePanTiltTranslationSpace.YRange.Min,
			p_req->RelativePanTiltTranslationSpace.YRange.Max);
    }

    if (p_req->RelativeZoomTranslationSpaceFlag)
    {
		offset += snprintf(p_buf+offset, mlen-offset, 			
			"<tt:RelativeZoomTranslationSpace>"
				...
				"</tt:XRange>"
			"</tt:RelativeZoomTranslationSpace>", 
			p_req->RelativeZoomTranslationSpace.XRange.Min,
			p_req->RelativeZoomTranslationSpace.XRange.Max);	
	}

	if (p_req->ContinuousPanTiltVelocitySpaceFlag)
	{
		offset += snprintf(p_buf+offset, mlen-offset, 	
			"<tt:ContinuousPanTiltVelocitySpace>"
				...
				"</tt:YRange>"
			"</tt:ContinuousPanTiltVelocitySpace>",
			p_req->ContinuousPanTiltVelocitySpace.XRange.Min,
			p_req->ContinuousPanTiltVelocitySpace.XRange.Max,
			p_req->ContinuousPanTiltVelocitySpace.YRange.Min,
			p_req->ContinuousPanTiltVelocitySpace.YRange.Max);	
	}

	if (p_req->ContinuousZoomVelocitySpaceFlag)
	{
		offset += snprintf(p_buf+offset, mlen-offset, 	
			"<tt:ContinuousZoomVelocitySpace>"
				...
				"</tt:XRange>"
			"</tt:ContinuousZoomVelocitySpace>",
			p_req->ContinuousZoomVelocitySpace.XRange.Min,
			p_req->ContinuousZoomVelocitySpace.XRange.Max);	
	}

	if (p_req->PanTiltSpeedSpaceFlag)
	{
		offset += snprintf(p_buf+offset, mlen-offset, 	
			"<tt:PanTiltSpeedSpace>"
				...
				"</tt:XRange>"
			"</tt:PanTiltSpeedSpace>",  
			p_req->PanTiltSpeedSpace.XRange.Min,
			p_req->PanTiltSpeedSpace.XRange.Max);	
	}

	if (p_req->ZoomSpeedSpaceFlag)
	{
		offset += snprintf(p_buf+offset, mlen-offset, 			
			"<tt:ZoomSpeedSpace>"
				...
				"</tt:XRange>"
			"</tt:ZoomSpeedSpace>",
			p_req->ZoomSpeedSpace.XRange.Min,
			p_req->ZoomSpeedSpace.XRange.Max);
	}
...
int build_PTZNodeExtension_xml(char * p_buf, int mlen, onvif_PTZNodeExtension * p_req)
{
    ...
    if (p_req->SupportedPresetTourFlag)
    {
        ...
        offset += snprintf(p_buf+offset, mlen-offset, 
            ...
            p_req->SupportedPresetTour.MaximumNumberOfPresetTours);

        if (p_req->SupportedPresetTour.PTZPresetTourOperation_Start)
        {
            offset += snprintf(p_buf+offset, mlen-offset, "<tt:PTZPresetTourOperation>Start</tt:PTZPresetTourOperation>");
        }
        if (p_req->SupportedPresetTour.PTZPresetTourOperation_Stop)
        {
            offset += snprintf(p_buf+offset, mlen-offset, "<tt:PTZPresetTourOperation>Stop</tt:PTZPresetTourOperation>");
        }
        if (p_req->SupportedPresetTour.PTZPresetTourOperation_Pause)
        {
            offset += snprintf(p_buf+offset, mlen-offset, "<tt:PTZPresetTourOperation>Pause</tt:PTZPresetTourOperation>");
        }
        if (p_req->SupportedPresetTour.PTZPresetTourOperation_Extended)
        {
            offset += snprintf(p_buf+offset, mlen-offset, "<tt:PTZPresetTourOperation>Extended</tt:PTZPresetTourOperation>");
        }
...
int build_PTZNode_xml(char * p_buf, int mlen, PTZNodeList * p_node)
{
	...
	offset += snprintf(p_buf+offset, mlen-offset, 
	    "<tptz:PTZNode token=\"%s\" FixedHomePosition=\"%s\" GeoMove=\"%s\">",
    ...
    for (i = 0; i < p_node->PTZNode.sizeAuxiliaryCommands; i++)
    {
        offset += snprintf(p_buf+offset, mlen-offset, 
            "<tt:AuxiliaryCommands>%s</tt:AuxiliaryCommands>",
            p_node->PTZNode.AuxiliaryCommands[i]);
    }

    if (p_node->PTZNode.ExtensionFlag)
    {
        offset += snprintf(p_buf+offset, mlen-offset, "<tt:Extension>"); 
        offset += build_PTZNodeExtension_xml(p_buf+offset, mlen-offset, &p_node->PTZNode.Extension);
        offset += snprintf(p_buf+offset, mlen-offset, "</tt:Extension>"); 
    }
...
int build_PTZVector_xml(char * p_buf, int mlen, onvif_PTZVector * p_req)
{
    ...
    if (p_req->PanTiltFlag)
    {
        ...
        offset += build_Vector_xml(p_buf+offset, mlen-offset, &p_req->PanTilt);
        offset += snprintf(p_buf+offset, mlen-offset, "</tt:PanTilt>");
    }
    ...
    if (p_req->ZoomFlag)
    {
        ...
        offset += build_Vector1D_xml(p_buf+offset, mlen-offset, &p_req->Zoom);
        offset += snprintf(p_buf+offset, mlen-offset, "</tt:Zoom>");
    }
...
int build_PTZPresetTourSpot_xml(char * p_buf, int mlen, onvif_PTZPresetTourSpot * p_req)
{
    ...
    offset += build_PTZPresetTourPresetDetail_xml(p_buf+offset, mlen-offset, &p_req->PresetDetail);
    offset += snprintf(p_buf+offset, mlen-offset, "</tt:PresetDetail>");
...
int build_PTZPresetTourStartingCondition(char * p_buf, int mlen, onvif_PTZPresetTourStartingCondition * p_req)
{
    ...
    {
        offset += snprintf(p_buf+offset, mlen-offset, "<tt:StartingCondition RandomPresetOrder=\"%s\">", p_req->RandomPresetOrder ? "true" : "false");
    }
    else
    {
    ...
    {
        offset += snprintf(p_buf+offset, mlen-offset, "<tt:RecurringTime>%d</tt:RecurringTime>", p_req->RecurringTime);
    }

    if (p_req->RecurringDurationFlag)
    {
        offset += snprintf(p_buf+offset, mlen-offset, "<tt:RecurringDuration>PT%dS</tt:RecurringDuration>", p_req->RecurringDuration);
    }

    if (p_req->DirectionFlag)
    {
        offset += snprintf(p_buf+offset, mlen-offset, "<tt:Direction>%s</tt:Direction>", onvif_PTZPresetTourDirectionToString(p_req->Direction));
    }
...
int build_PTZPresetTourStartingConditionOptions_xml(char * p_buf, int mlen, onvif_PTZPresetTourStartingConditionOptions * p_req)
{
    ...
    if (p_req->RecurringDurationFlag)
    {
        ...
        offset += build_DurationRange_xml(p_buf+offset, mlen-offset, &p_req->RecurringDuration);
        offset += snprintf(p_buf+offset, mlen-offset, "</tt:RecurringDuration>");
    }

    if (p_req->PTZPresetTourDirection_Forward)
    {
        offset += snprintf(p_buf+offset, mlen-offset, "<tt:Direction>Forward</tt:Direction>");
    }
    if (p_req->PTZPresetTourDirection_Backward)
    {
        offset += snprintf(p_buf+offset, mlen-offset, "<tt:Direction>Backward</tt:Direction>");
    }
    if (p_req->PTZPresetTourDirection_Extended)
    {
        offset += snprintf(p_buf+offset, mlen-offset, "<tt:Direction>Extended</tt:Direction>");
    }
...
int build_Space2DDescription_xml(char * p_buf, int mlen, onvif_Space2DDescription * p_req)
{
    ...
    offset += snprintf(p_buf+offset, mlen-offset, "<tt:URI>%s</tt:URI>", p_req->URI);        

    offset += snprintf(p_buf+offset, mlen-offset, "<tt:XRange>");
    offset += build_FloatRange_xml(p_buf+offset, mlen-offset, &p_req->XRange);
    offset += snprintf(p_buf+offset, mlen-offset, "</tt:XRange>");

    offset += snprintf(p_buf+offset, mlen-offset, "<tt:YRange>");
    offset += build_FloatRange_xml(p_buf+offset, mlen-offset, &p_req->YRange);
    offset += snprintf(p_buf+offset, mlen-offset, "</tt:YRange>");
...
int build_PTZPresetTourPresetDetailOptions_xml(char * p_buf, int mlen, onvif_PTZPresetTourPresetDetailOptions * p_req)
{
    ...
    for (i = 0; i < p_req->sizePresetToken; i++)
    {
        offset += snprintf(p_buf+offset, mlen-offset, "<tt:PresetToken>%s</tt:PresetToken>", p_req->PresetToken[i]);
    }
    ...
    if (p_req->PanTiltPositionSpaceFlag)
    {
        ...
        offset += build_Space2DDescription_xml(p_buf+offset, mlen-offset, &p_req->PanTiltPositionSpace);
        offset += snprintf(p_buf+offset, mlen-offset, "</tt:PanTiltPositionSpace>");
    }
    ...
    if (p_req->ZoomPositionSpaceFlag)
    {
        ...
        offset += build_Space1DDescription_xml(p_buf+offset, mlen-offset, &p_req->ZoomPositionSpace);
        offset += snprintf(p_buf+offset, mlen-offset, "</tt:ZoomPositionSpace>");
    }
...
int build_PTZPresetTourSpotOptions_xml(char * p_buf, int mlen, onvif_PTZPresetTourSpotOptions * p_req)
{
    ...
    offset += snprintf(p_buf+offset, mlen-offset, "<tt:PresetDetail>");
    offset += build_PTZPresetTourPresetDetailOptions_xml(p_buf+offset, mlen-offset, &p_req->PresetDetail);
    offset += snprintf(p_buf+offset, mlen-offset, "</tt:PresetDetail>");

    offset += snprintf(p_buf+offset, mlen-offset, "<tt:StayTime>");
    offset += build_DurationRange_xml(p_buf+offset, mlen-offset, &p_req->StayTime);
    offset += snprintf(p_buf+offset, mlen-offset, "</tt:StayTime>");
...
int build_PTZPresetTourOptions_xml(char * p_buf, int mlen, onvif_PTZPresetTourOptions * p_req)
{
    ...
    offset += snprintf(p_buf+offset, mlen-offset, "<tt:StartingCondition>");
    offset += build_PTZPresetTourStartingConditionOptions_xml(p_buf+offset, mlen-offset, &p_req->StartingCondition);
    offset += snprintf(p_buf+offset, mlen-offset, "</tt:StartingCondition>");

    offset += snprintf(p_buf+offset, mlen-offset, "<tt:TourSpot>");
    offset += build_PTZPresetTourSpotOptions_xml(p_buf+offset, mlen-offset, &p_req->TourSpot);
    offset += snprintf(p_buf+offset, mlen-offset, "</tt:TourSpot>");
...
{
    int offset = 0;
    ptz_GetCompatibleConfigurations_REQ * p_req = (ptz_GetCompatibleConfigurations_REQ *)argv;
    PTZConfigurationList * p_ptz_cfg = g_onvif_cfg.ptz_cfg;
    ONVIF_PROFILE * p_profile = onvif_find_profile(g_onvif_cfg.profiles, p_req->ProfileToken);
...
int build_ptz_GetPresets_rly_xml(char * p_buf, int mlen, const char * argv)
{
    ...
    while (p_preset)
    {
    	...
    	offset += snprintf(p_buf+offset, mlen-offset, 
    		"<tt:Name>%s</tt:Name>", 
    		p_preset->PTZPreset.Name);
    		
		if (p_preset->PTZPreset.PTZPositionFlag)
		{
			offset += snprintf(p_buf+offset, mlen-offset, "<tt:PTZPosition>");
			if (p_preset->PTZPreset.PTZPosition.PanTiltFlag)
			{
		    	offset += snprintf(p_buf+offset, mlen-offset, 
		    		"<tt:PanTilt x=\"%0.1f\" y=\"%0.1f\" />",
		    		p_preset->PTZPreset.PTZPosition.PanTilt.x,
		    		p_preset->PTZPreset.PTZPosition.PanTilt.y);
		    }
		    if (p_preset->PTZPreset.PTZPosition.ZoomFlag)
		    {
		    	offset += snprintf(p_buf+offset, mlen-offset, 
		    		"<tt:Zoom x=\"%0.1f\" />",
		    		p_preset->PTZPreset.PTZPosition.Zoom.x);
		    }        
	        offset += snprintf(p_buf+offset, mlen-offset, "</tt:PTZPosition>");
	    }
...
int build_ptz_GetPresetTours_rly_xml(char * p_buf, int mlen, const char * argv)
{
	...
	while (p_tour)
	{
	    offset += snprintf(p_buf+offset, mlen-offset, "<tptz:PresetTour token=\"%s\">", p_tour->PresetTour.token);
...
int build_ptz_GetPresetTourOptions_rly_xml(char * p_buf, int mlen, const char * argv)
{
    ...
    offset += snprintf(p_buf+offset, mlen-offset, "<tptz:GetPresetTourOptionsResponse><tptz:Options>");
    offset += build_PTZPresetTourOptions_xml(p_buf+offset, mlen-offset, &p_res->Options);    
    offset += snprintf(p_buf+offset, mlen-offset, "</tptz:Options></tptz:GetPresetTourOptionsResponse>");
...
int build_ConfigDescription_xml(char * p_buf, int mlen, onvif_ConfigDescription * p_req)
{
    int offset = 0;
    SimpleItemDescriptionList * p_simpleitem_desc;
...
int build_EndpointReferenceType_xml(char * p_buf, int mlen, onvif_EndpointReferenceType * p_req)
{
    int offset = 0;
...
int build_TopicExpressionType_xml(char * p_buf, int mlen, onvif_EndpointReferenceType * p_req)
{
    int offset = 0;
...
int build_NotificationMessageHolderType_xml(char * p_buf, int mlen, onvif_NotificationMessageHolderType * p_req)
{
    int offset = 0;
    ...
    if (p_req->SubscriptionReferenceFlag)
    {
        ...
        offset += build_EndpointReferenceType_xml(p_buf+offset, mlen-offset, &p_req->SubscriptionReference);
        offset += snprintf(p_buf+offset, mlen-offset, "</wsnt:SubscriptionReference>");
    }
    ...
    if (p_req->ProducerReferenceFlag)
    {
        ...
        offset += build_EndpointReferenceType_xml(p_buf+offset, mlen-offset, &p_req->ProducerReference);
        offset += snprintf(p_buf+offset, mlen-offset, "</wsnt:ProducerReference>");
    }
...
int build_FindEventResult_xml(char * p_buf, int mlen, onvif_FindEventResult * p_req)
{
	...
	offset += build_NotificationMessageHolderType_xml(p_buf+offset, mlen-offset, &p_req->Event);
	offset += snprintf(p_buf+offset, mlen-offset, "</tt:Event>");
...
int build_tac_GetAreaInfoList_rly_xml(char * p_buf, int mlen, const char * argv)
{
    ...
    AreaInfoList * p_info = p_res->AreaInfo;
...
int build_tac_GetAreaInfo_rly_xml(char * p_buf, int mlen, const char * argv)
{
    ...
    for (i = 0; i < ARRAY_SIZE(p_req->token); i++)
    {
        ...
        p_info = onvif_find_AreaInfo(g_onvif_cfg.area_info, p_req->token[i]);
        if (p_info)
        {
            offset += build_AreaInfo_xml(p_buf+offset, mlen-offset, &p_info->AreaInfo);
        }
...
{
    int offset = 0;
    tmd_GetAudioOutputConfiguration_REQ * p_req = (tmd_GetAudioOutputConfiguration_REQ *)argv; 
    AudioOutputConfigurationList * p_cfg = onvif_find_AudioOutputConfiguration_by_OutputToken(g_onvif_cfg.a_output_cfg, p_req->AudioOutputToken);
    if (NULL == p_cfg)
    {
...
{
    int offset = 0;
    tmd_GetAudioOutputConfigurationOptions_REQ * p_req = (tmd_GetAudioOutputConfigurationOptions_REQ *)argv; 
    AudioOutputConfigurationList * p_cfg = onvif_find_AudioOutputConfiguration_by_OutputToken(g_onvif_cfg.a_output_cfg, p_req->AudioOutputToken);
    if (NULL == p_cfg)
    {
        return ONVIF_ERR_NoAudioOutput;
...
int build_tr2_GetAudioDecoderConfigurations_rly_xml(char * p_buf, int mlen, const char * argv)
{
    ...
    if (p_req->GetConfiguration.ConfigurationTokenFlag)
    {
        p_a_dec_cfg = onvif_find_AudioDecoderConfiguration(g_onvif_cfg.a_dec_cfg, p_req->GetConfiguration.ConfigurationToken);
        if (NULL == p_a_dec_cfg)
        {
            return ONVIF_ERR_NoConfig;
        }
...
int build_tr2_GetAudioOutputConfigurations_rly_xml(char * p_buf, int mlen, const char * argv)
{
    ...
    if (p_req->GetConfiguration.ConfigurationTokenFlag)
    {
        p_a_output_cfg = onvif_find_AudioOutputConfiguration(g_onvif_cfg.a_output_cfg, p_req->GetConfiguration.ConfigurationToken);
