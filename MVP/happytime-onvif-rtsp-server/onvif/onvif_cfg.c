...
AudioSourceConfigurationList * onvif_parse_audio_source_cfg(XMLN * p_audio_source)
{	
...
AudioEncoder2ConfigurationList * onvif_parse_audio_encoder_cfg(XMLN * p_audio_encoder)
{
    XMLN * p_session_timeout;
    XMLN * p_sample_rate;
    XMLN * p_bitrate;
	...
	p_a_enc_cfg = onvif_add_AudioEncoder2Configuration(&a_enc_cfg);
